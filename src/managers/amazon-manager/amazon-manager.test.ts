...
import {AmazonManager} from "./amazon-manager";

describe('Amazon Manager', () => {
  test('Parses transactions web page correctly', () => {
    ...
    expect(amazonManager.parseTransactions(webPage)).toStrictEqual([
      {
  ...
  test('Parses orders web page correctly', () => {
    ...
    expect(amazonManager.parseOrders(webPage)).toStrictEqual([
      {
